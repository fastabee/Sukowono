...
foreach($split as $op) {?>
    ...
    <?php foreach ($op as $value) {?>
        <td valign="top">
            ...
            <div id="header1_div">
                <h1> KARTU ANGGOTA PERPUSTAKAAN SDN 02 SUKOKOWONO          <h2>Jalan Pahlawan No.04 Sukowono Jember</h2></div>
        ...
        <td valign="top">
            ...
            <div id="header2_div">
                <h1>KARTU ANGGOTA PERPUSTAKAAN <br /> SDN 02 SUKOKOWONO</h1><h3>Jalan Pahlawan No.04 Sukowono Jember<br></h3><hr></div>
            <div id="rules_div">
                <ul>
                    <li>Kartu ini diterbitkan oleh Perpustakaan SDN 02 SUKOKOWONO. Segala Penggunaan kartu diatur oleh Perpustakaan SDN 02 SUKOKOWONO sesuai ketentuan dan syarat yang berlaku</li>
                    <li>Bila menemukan kartu ini mohon mengembalikan ke SDN 02 SUKOKOWONO</li>
            ...
            <div class="sign_file_div"><!-- <img class="" height="40px" width="100px" src="<?php echo base_url(); ?>assets/membercard/signature.png" > --></div>
                <p class="stamp city">Jember, </p>
                <p class="stamp title">Petugas Perpustakaan Perpustakaan</p><br>
                <p class="stamp officials">Megawati<br>NIP</p>
            </div>
            </div>
        </td>
