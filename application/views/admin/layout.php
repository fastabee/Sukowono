...
<div class="wrapper">
         ...
         <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url();?>admin/Petugas" class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2023 <a href="#">SDN 02 SUKOWONO</a>.</strong> All rights reserved.
  </footer>
