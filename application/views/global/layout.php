        ...
        <div class="container">
            <div class="left-div">
                <div class="user-settings-wrapper">
                    <ul class="nav">
                    <center><font color="#04FF00"><h1> SEKOLAH DASAR NEGERI 02 SUKOWONO  <B></font><font color="#FFFF00"></B></h1></font></center>   
                    </ul>
                </div>
            </div>
        </div>
...
<footer>
        <div class="container" align="center">
            <div class="row">
                <div class="col-md-12">
                    &copy; 2023 | By : <a href="#" target="_blank">POLIJE X SDN 02 SUKOWONO </a>
                </div>
